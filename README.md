...
El porcentaje de facturas pagadas con atraso bajó de **64,3 % (2022) a 35,8 % (2026)**, y el DPD promedio pasó de **+3,9 días a −1,1**: hoy los clientes pagan, en promedio, un día *antes* del vencimiento. La serie completa está en [Cumplimiento de pago por año](#cumplimiento).
...
Todo lo anterior es qué hace el dashboard. Lo que sigue es por qué está construido de esta forma y no de otra.
...
Con las fechas corregidas, el DPD promedio de 2022 pasó de −25.849 a **+3,9 días**.

---

<a id="sobre-los-datos"></a>
